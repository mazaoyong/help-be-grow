const STATIC_ASSETS = {
  ...
  notExist: 'https://b.yzcdn.cn/cdn/not-found.png',
};
  ...
  */
  {
    ...
    text: '生成海报',
    onClick: function() {
      this.$emit('logGeneratePoster');
      window.location.href = `${_global.url.v4}/vis/h5/edu/moments/poster?postId=${this.postDetail.postId}`;
    },
  },
  {
    value: 0,
