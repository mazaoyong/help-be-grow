...
/* com.youzan.owl.pc.api.lesson.StudentLessonDetectFacade -  */
class StudentLessonDetectService extends BaseService {
  get SERVICE_NAME() {
    return 'com.youzan.owl.pc.api.lesson.StudentLessonDetectFacade';
  }

  /**
   *  用户合约时间冲突检测
   *  zanAPI文档地址: http://zanapi.qima-inc.com/site/service/view/496415
   *
...
module.exports = StudentLessonDetectService;
