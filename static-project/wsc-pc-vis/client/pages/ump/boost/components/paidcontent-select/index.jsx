...
export default class GoodsSelect extends Component {
    ...
    ajax({
      ...
      .then(data => {
        ...
        const datasets = items.map(item => {
          if (this.props.selectedRowKeys.includes(item.item_id)) {
            item.join = 0;
          }
          return item;
        });
        this.setState({
          ...
          datasets,
          paginator: {
            pageSize: data.paginator.page_size,
            current: data.paginator.page,
            totalItem: data.paginator.total_count,
          },
        });
      })
      .catch(({ msg }) => {
  ...
  handleSelectChange = evt => {
    this.setState({ types: evt.target.value }, () => {
      this.getGoodsData();
    });
  };
    ...
    return (
      <div className="modal-filter">
        ...
        {/* <SearchInput
            ...
            onPressEnter={() => this.getGoodsData()}
          /> */}
        <div />
        <div className="right">
          <Select
