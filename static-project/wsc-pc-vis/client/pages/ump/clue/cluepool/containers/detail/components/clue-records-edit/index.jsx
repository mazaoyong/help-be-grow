 ...
 */
const ClueRecordsEdit = ({ dialogref, data = {} }) => {
  ...
  }, [clueId, imageList, recordText, revisitTime]);
  ...
  const handleUpdateRecord = useCallback(() => {
    ...
    updateClueRecordAPI(req)
      ...
      .catch(() => {
        Notify.error('更新动态记录失败');
      })
      .finally(() => {
        setLoading(false);
      });
  }, [clueId, data.id, dialogref, imageList, recordText, revisitTime]);
