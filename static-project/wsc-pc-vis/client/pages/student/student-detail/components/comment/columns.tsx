...
export const columns: (type: number, onRefresh: (boolean)=>void, queryData: any)
=> IGridColumn[] = (type, onRefresh, queryData) => {
  return [
    {
      title: '评论内容',
      name: 'textContent',
    ...
    },
    {
      ...
      bodyRender(data) {
        ...
        return (
          <div className="moments_operation_wrap">
            <ReplyDialog
              postId={postId}
            ...
            <span style={{ color: '#DCDEE0' }}> | </span>
            <OperationPop postId={postId} mentionedUsers={mentionedUsers} setLoading={onRefresh} />
          </div>
        );
      },
    },
