    ...
    () => ({
      ...
      onFetch: data => {
        ...
        return findStudentPageWithCustomer({
          ...
          totalItem: total,
          datasets: content.map(({ student = {}, customer = {} }) => {
            const resStudent: Record<string, any> = student;
            const resCustomer: Record<string, any> = customer;
            return {
              userName: resStudent.name,
              userId: resStudent.userId,
              mobile: resStudent.mobile,
              parentName: resCustomer.name,
              parentId: resCustomer.userId,
              lastClassTime: resStudent.lastClassTime,
            };
          }),
        }));
      },
