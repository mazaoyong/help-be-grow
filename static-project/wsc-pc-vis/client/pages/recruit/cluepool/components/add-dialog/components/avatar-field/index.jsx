...
class AvatarField extends PureComponent {
  render() {
    const { value } = this.props;
    if (value) {
      return (
        <span className="avatar-upload_wrapper">
          <img width="80" height="80" src={value} />
          <span className="avatar-upload_a" onClick={this.handleRemove}>
            ×
          </span>
        </span>
      );
...
export default getControlGroup(AvatarField);
