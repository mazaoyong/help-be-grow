  ...
  return (
    <div className="dialog-content">
      <div className={wrapClassName}>
        <label className="zent-form__control-label" style={{ width: '100px' }}><em className="zent-form__required">*</em>课程顾问：</label>
        <Select
          data={options}
          optionValue="adminId"
          optionText="name"
        ...
        />
        {check && <p className="zent-form__error-desc">请选择课程顾问</p>}
      </div>
      <DialogFooter>
