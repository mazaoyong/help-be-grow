      ...
      <div className="tag-list">
        ...
        <Grid
          ...
          batchRender={() =>
            checkAccess('编辑') ? (
              <div>
                <label style={{ marginRight: '8px' }}>当页全选</label>
                <Button key="batch-delete" onClick={this.handleBatchDelete}>
                  删除
                </Button>
                <Button key="batch-change" onClick={this.handleBatchChangeGroup}>
                  换组
                </Button>
              </div>
            ) : null
