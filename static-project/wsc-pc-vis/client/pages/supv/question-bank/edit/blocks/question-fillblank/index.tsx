...
import { IQuestionFillBlankProps } from './types';

const { EasyForm } = EasyFormArchive;

const QuestionFillBlank = React.forwardRef<ZentForm<any> | undefined, IQuestionFillBlankProps>(
  function QuestionFillBlankWithRef(props, ref) {
    ...
    React.useLayoutEffect(() => {
      ...
      if (form) {
        const stashQuestionContent = getStashQuestionContent(QuestionType.FillBlank);
