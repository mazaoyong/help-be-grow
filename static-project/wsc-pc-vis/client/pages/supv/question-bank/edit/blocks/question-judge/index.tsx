...
const QuestionJudge = React.forwardRef<ZentForm<any> | undefined, IQuestionJudgeProps>(
  function QuestionJudgeWithRef(props, ref) {
    ...
    React.useLayoutEffect(() => {
      ...
      if (form) {
        const stashQuestionContent = getStashQuestionContent(QuestionType.Judge);
