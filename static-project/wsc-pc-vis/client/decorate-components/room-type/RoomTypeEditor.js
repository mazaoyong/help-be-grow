...
import openRoomTypeListDialog from '../common/dialog/room-type-list-dialog';
...
class RoomTypeEditor extends DesignEditor {
  ...
  render() {
    ...
    return (
      <div className="rc-design-component-room-type-editor">
        <ComponentTitle name="房型" />

        <ControlGroup
          className="rc-design-component-room-type-editor__title-bar"
          label="标题栏"
        ...
        {+showTitle ? (
          <ControlGroup
            className="rc-design-component-room-type-editor__title"
            label="标题名称"
            labelAlign="top"
        ...
        <ControlGroup
          className="rc-design-component-room-editor__list-label"
          label="选择房型"
          helpDesc="最多添加50个房型，拖动选中的房型可对其排序"
        />

        <ControlGroup
          className="rc-design-component-room-type-editor__list"
          showLabel={false}
          bgColored
        >
          <EditorCard
          ...
          >
            {subEntry.map((item, index) => {
              return (
                <div key={index} className="rc-design-component-room-type-editor__subentry-item">
                  <i className="rc-design-component-room-type-editor__icon-drag" />
                  <a href={item.url} target="_blank" rel="noopener noreferrer">
                    {item.name}
                  </a>
                  <i
                    className="rc-design-component-room-type-editor__icon-delete"
  ...
  static info = {
    icon: 'https://img.yzcdn.cn/upload_files/2020/01/21/FvuMAE9VYSfkq1DSqP5xBX28jsKA.png',
    type: 'room_type',
    name: '房型',
    description: '房型',
    maxNum: 5,
