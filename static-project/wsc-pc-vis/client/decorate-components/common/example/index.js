...
import { Button, Slider, Input, Radio, Switch } from 'zent';
...
const DEFAULT_IMAGE_1 =
  'https://img.yzcdn.cn/upload_filesshowHeader/2018/12/17/31ad4812a19c84521863424e4bc2d034.jpg?imageView2/2/w/100/h/100/q/75/format/webp';
    ...
    subEntry: [
      {
        ...
        image_url: 'https://img.yzcdn.cn/upload_files/2019/01/15/FiZNujZ2janLtykWkR6DU6oLE7Ex.jpg',
        image_width: 500,
        images: [
          {
            image_url:
              'https://img.yzcdn.cn/upload_files/2019/01/15/FiZNujZ2janLtykWkR6DU6oLE7Ex.jpg',
          },
          {
            image_url:
              'https://img.yzcdn.cn/upload_files/2019/01/19/c20bad8beb5d2e626348312d6887092b.jpg',
          },
        ],
        link_id: 77973177,
          ...
          <EditorCard list={subEntry} onChange={this.handleEntryListChange} canDelete>
            {subEntry.map((item, index) => (
              <SubEntryItem
                ...
                settings={{}}
                index={index}
                // header={<CheckBox checked={true}>店铺主页</CheckBox>}
                showHeader
                showHandler
                // showContent={false}
                block
