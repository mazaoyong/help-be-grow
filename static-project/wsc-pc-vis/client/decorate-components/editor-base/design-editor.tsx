...
type IDesignState<T> = IDesignEditorState & T;

export class DesignEditor<T = {}> extends React.Component<IDesignEditorProps, IDesignState<T>> {
  static propTypes = {
  ...
  static validate(_value, _prevValue, _changedProps) {
