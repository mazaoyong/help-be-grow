...
import { Radio, Input, Icon, Notify } from 'zent';
import CheckBox from 'zent/es/checkbox';
import { Divider, EditorCard, ControlGroup, RadioButton, ComponentTitle, Control } from '../common';
...
export default class CouponEditor extends DesignEditor {
  ...
  render() {
    ...
    return (
      <div className="decorate-coupon-editor">
        <ComponentTitle
          name="优惠券"
  ...
  static designType = ['coupon_weapp', 'coupon'];
