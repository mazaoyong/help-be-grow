...
export const componentType = {
  ...
  PUNCH: 'punch',
  SALES_BUSINESS_INFO: 'salesmanBusinessInfo',
  SALES_INFO_EDIT: 'salesmanInfoEdit',
  SALES_COMPANY: 'salesmanMyCompany',
  SALES_RECOMMEND_GOODS_TEMPLATE: 'salesman_recommend_goods',
};
