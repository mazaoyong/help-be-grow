...
export type EduGoodsType =
  ...
  | 'contentAudio'
  | 'contentVideo';
export type SelectTypes = 'all' | 'part';
export enum OwlItemType {
  ALL,
  COLUMN,
  CONTENT,
  LIVE = 4,
...
export interface IEduGoodsSelectorProps
  extends Omit<ISelectorDialogProps, 'selected' | 'onSelectOk' | 'config' | 'dict'> {
  /** 选中商品的数据 */
