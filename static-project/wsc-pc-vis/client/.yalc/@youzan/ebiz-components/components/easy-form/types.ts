...
export interface IEasyFormProps extends SlimFormProps {
  ...
  // 很奇怪，这个版本的zent form props的定义没有这个
   ...
   */
  renderSubmit?:
    | ((cb: (...args: any[]) => void, easyForm: IEasyFormInstance) => React.ReactNode)
    | boolean;
...
type OriginalFormType = ZentForm<Record<string, EasyFormModelType>>;
...
export type EasyFormRefType = IEasyFormInstance
export type EasyFormWatchFunction<Value = any> = (
  value: Value,
  ctx: IEasyFormWatchCtx,
  easyForm: OriginalFormType
) => void;
...
// interface IEasyFormHooksLikeWatcher {
//   factory: EasyFormWatchFunction<Record<string, any>>;
//   deps: string[];
// }
export type EasyFormWatchType = /** IEasyFormHooksLikeWatcher |*/ Record<
  string,
  EasyFormWatchFunction<any>
>;
export type EasyFormConfigLabel = ((name: string, index: number) => string) | string;
 ...
 * 需要options属性的类型
 */
export type EasyFormOptionsRequiredTypes = (
  | IEasyFormSelectConfig
  | IEasyFormCheckboxConfig
  | IEasyFormRadioConfig
) &
  IEasyFormBaseConfig;
...
interface IEasyFormColorPickerConfig
  extends INoValueProps<IColorPickerProps & IEasyFormExtendsColorPickerProps> {
  type: 'ColorPicker';
}
...
interface IEasyFormDateRangePickerConfig
  extends INoValueProps<
    Omit<IDateRangeQuickPickerProps, 'onChange' | 'format' | 'preset'>,
    [[string, string], any]
  > {
...
type EasyFormPlainType = {
  type: 'Plain';
  node: React.ReactNode;
} & IEasyFormBaseConfig;
export type EasyFormInternalListType = IForbidden_InternalListConfig & IEasyFormBaseConfig;
export type EasyFormInternalGroupType = IForbidden_InternalGroupConfig & IEasyFormBaseConfig;
export type EasyFormConfigValidType = (
  | IEasyFormInputConfig
  | IEasyFormNumberInputConfig
  | IEasyFormSelectConfig
  | IEasyFormCheckboxConfig
  | IEasyFormRadioConfig
  | IEasyFormCustomConfig
  | IEasyFormSwitchConfig
  | IEasyFormColorPickerConfig
  | IEasyFormDatePickerConfig
  | IEasyFormDateRangePickerConfig
) &
  IEasyFormBaseConfig;
export type EasyFormConfigType =
  | EasyFormPlainType
  | EasyFormConfigValidType
...
export type FieldInjectPropsType<ValueType> = IEasyFormBaseConfig &
  Required<IFieldBaseConfigHandlerProps<ValueType>>;
...
export type EasyFormFieldProps<P> = IEasyFormFiledBaseProps & P;
/** 内部类型的数据格式，比如list和group类型，需要有自己的状态，需要额外定义成set类型 */
export type EasyFormInternalType<P extends BasicModel<any>> = FieldSetModel<{
...
// model types
export type NormalEasyFormModel = FieldModel<any>;
export type GroupEasyFormModel = FieldSetModel<Record<string, NormalEasyFormModel>>;
export type ListEasyFormModel = FieldArrayModel<any>;
export type EasyFormModelType = NormalEasyFormModel | GroupEasyFormModel | ListEasyFormModel;
// status type
export type NormalStatusModel = FieldModel<IFieldStatus>;
export type GroupStatusModel = FieldSetModel<Record<string, NormalStatusModel>>;
export type ListStatusModel = NormalStatusModel;
export type EasyFormStatusModelType = NormalStatusModel | GroupStatusModel | ListStatusModel;
