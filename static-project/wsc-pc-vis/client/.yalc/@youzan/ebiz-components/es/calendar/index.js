...
function (_PureComponent) {
  _inherits(CalendarPanel, _PureComponent);
  ...
  function CalendarPanel() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(CalendarPanel)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "state", {
      active: new Date()
    });

    _defineProperty(_assertThisInitialized(_this), "handleDayClick", function (date) {
      if (_this.props.onSelect) {
        ...
        if (!dateFns_85(date, _this.props.current) && _this.props.onMonthChange) {
          _this.props.onMonthChange(date);
        }
      }
    });

    _defineProperty(_assertThisInitialized(_this), "getDayCellClassName", function (day) {
      var _cx;

      var date = day.date,
          today = day.today,
          week = day.week,
          preMonth = day.preMonth,
          nextMonth = day.nextMonth;
      return cx((_cx = {
        day: true
      }, _defineProperty(_cx, week, true), _defineProperty(_cx, "preMonth", preMonth), _defineProperty(_cx, "nextMonth", nextMonth), _defineProperty(_cx, "today", today), _defineProperty(_cx, "active", dateFns_80(date, _this.state.active)), _cx));
    });
  ...
  _createClass(CalendarPanel, [{
    ...
    value: function renderDays() {
      var calendarDays = zanMediaSdk.calendar.getWeeks(this.props.weekStartsOn);
      return React__default.createElement("div", {
        className: "ebiz-calendar__panel__days ebiz-calendar__panel__row"
    ...
    value: function renderCell() {
      ...
      var calendarData = zanMediaSdk.calendar.getMonthCalender(current, weekStartsOn);
      return React__default.createElement("div", {
        className: "ebiz-calendar__panel__body"
      }, calendarData.map(function (week, i) {
        return React__default.createElement("div", {
          className: "ebiz-calendar__panel__row",
          key: i
          ...
          return React__default.createElement("div", {
            ...
            className: _this2.getDayCellClassName(day),
            onClick: function onClick() {
              return _this2.handleDayClick(day.date);
            }
          }, _this2.props.dateFullCellRender ? _this2.props.dateFullCellRender(day.date) : React__default.createElement("div", {
            className: "full-calendar__cell"
          }, React__default.createElement("p", {
            className: "full-calendar__cell__header"
          }, dateFns_50(day.date, 'D')), React__default.createElement("div", {
            className: "full-calendar__content"
          }, _this2.props.dateCellRender && _this2.props.dateCellRender(day.date)))));
        }));
      }));
    }
  }, {
    ...
    value: function render() {
      return React__default.createElement("div", {
        className: "ebiz-calendar__panel"
      }, this.renderDays(), this.renderCell());
    }
  }], [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (!dateFns_85(nextProps.current, prevState.active)) {
        var diffMonth = dateFns_19(nextProps.current, prevState.active);
        return {
          active: dateFns_6(prevState.active, diffMonth)
        };
      }
...
function (_PureComponent) {
  ...
  function CalendarHeader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "prevMonth", function () {
      _this.props.onMonthChange(dateFns_150(_this.props.current, 1));
    });

    _defineProperty(_assertThisInitialized(_this), "nextMonth", function () {
      _this.props.onMonthChange(dateFns_6(_this.props.current, 1));
    });
  ...
  _createClass(CalendarHeader, [{
    ...
    value: function render() {
      return React__default.createElement("div", {
        className: "ebiz-calendar__header"
      }, React__default.createElement("div", {
        className: "ebiz-calendar__header__operate"
      }, React__default.createElement("div", {
        className: "prev",
        onClick: this.prevMonth
      }, React__default.createElement(zent.Icon, {
        type: "right"
      })), React__default.createElement("div", null, this.current), React__default.createElement("div", {
        className: "next",
    ...
    get: function get() {
      ...
      return dateFns_50(current, 'YYYY-MM');
    } // 上一月
...
function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      var _this$props = this.props,
          current = _this$props.current,
          weekStartsOn = _this$props.weekStartsOn,
          _onMonthChange = _this$props.onMonthChange,
          onSelect = _this$props.onSelect,
          dateFullCellRender = _this$props.dateFullCellRender,
          dateCellRender = _this$props.dateCellRender;
      console.log(this.props);
      return React__default.createElement("div", {
        className: "ebiz-calendar"
      }, React__default.createElement(CalendarHeader, {
        current: current,
        onMonthChange: function onMonthChange(date) {
          return _onMonthChange(date);
        }
      }), React__default.createElement(CalendarPanel, {
  ...
  return Calendar;
}(React.Component); // const useCount = (num, delay) => {

var CalendarModule = {
  Calendar: Calendar,
  CalendarPanel: CalendarPanel,
  CalenderHeader: CalendarHeader
};
