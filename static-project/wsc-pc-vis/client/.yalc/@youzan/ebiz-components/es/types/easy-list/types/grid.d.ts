import { IGridProps, IGridSelection, IGridPageInfo, IGridColumn, PopPositions, IconType, ITagProps, IPopProps, Sweetalert, IPopoverContext, IInputProps } from 'zent';
import React from 'react';
import { IListContext } from './list';
import { ISyncValidator } from 'formulr';
export declare type EasyGridSelectType = 'single' | 'multiple';
...
export interface IEasyGridProps extends Omit<IGridProps, 'columns' | 'datasets' | 'selection' | 'pageInfo'> {
...
export declare type IBodyRenderFunc = (data: any, pos: {
    row: number;
    column: number;
    fixed?: 'left' | 'right';
...
declare type IGridPopChildren = (ctx: IGridPopChildrenProps) => React.ReactNode;
...
declare type IGridSweetAlertChildren = (ctx: IGridSweetAlertChildrenProps) => React.ReactNode;
