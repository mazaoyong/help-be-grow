export declare type HistoryModeType = 'hash' | 'browser' | 'none';
export declare type QueryFormatterType = (params: Record<string, any>) => Record<string, any>;
export declare type FilterNormalizerType = (filter: Record<string, any>) => Record<string, any>;
...
declare type FetchFn = (state: IRequestParams, globalState: IGlobalState, reason?: Reason) => Promise<IFormatData>;
