...
var CalendarPanel$1 = CalendarModule.CalendarPanel;

var MonthSchedule =
/*#__PURE__*/
function (_Component) {
  _inherits(MonthSchedule, _Component);
  ...
  function MonthSchedule() {
    ...
    _classCallCheck(this, MonthSchedule);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MonthSchedule)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "dateCellRender", function (date) {
      ...
      if (dateCellRender && !dateFullCellRender) {
        var dayDate = data[dateFns_50(date, 'YYYY-MM-DD')] || [];
    ...
    _defineProperty(_assertThisInitialized(_this), "dateFullCellRender", function (date) {
      var _this$props2 = _this.props,
          data = _this$props2.data,
          dateFullCellRender = _this$props2.dateFullCellRender;
  ...
  _createClass(MonthSchedule, [{
    key: "render",
    value: function render() {
      var _this$props3 = this.props,
          current = _this$props3.current,
          weekStartsOn = _this$props3.weekStartsOn,
          onMonthChange = _this$props3.onMonthChange,
          onSelect = _this$props3.onSelect,
          dateCellRender = _this$props3.dateCellRender,
          dateFullCellRender = _this$props3.dateFullCellRender;
      return React__default.createElement("div", {
        className: "ebiz-schedule__month"
      }, React__default.createElement(CalendarPanel$1, {
        weekStartsOn: weekStartsOn,
        current: current,
        onMonthChange: onMonthChange,
        onSelect: onSelect,
        dateCellRender: dateCellRender ? this.dateCellRender : undefined,
        dateFullCellRender: dateFullCellRender ? this.dateFullCellRender : undefined
      }));
    }
  }]);
...
var getCellClassName = function getCellClassName(time, interval, data, days) {
  var className = 'ebiz-schedule__timeline__cell';
  var now = new Date().getTime(); // 周的当前时间箭头

  if (days === 7 && now > start_of_week(data[0]).getTime() && now < end_of_week(data[0]).getTime()) {
    time = add_days(time, difference_in_calendar_days(now, time)).getTime();
  }
...
var TimeLine = function TimeLine(_ref) {
  var data = _ref.data,
      _ref$days = _ref.days,
      days = _ref$days === void 0 ? 1 : _ref$days,
      interval = _ref.interval,
      rowHeight = _ref.rowHeight;
  return React__default.createElement("div", {
    className: "ebiz-schedule__timeline"
  }, data.map(function (time) {
    return React__default.createElement("div", {
      key: time,
      className: getCellClassName(time, interval, data, days),
      style: {
        height: "".concat(rowHeight, "px")
      }
    }, dateFns_50(time, 'HH:mm'));
  }));
};
...
var Box = function Box(_ref) {
  ...
  React.useEffect(function () {
    connectDragPreview(HTML5Backend.getEmptyImage(), {
...
var DragEvent = reactDnd.DragSource('box', {
  beginDrag: function beginDrag(props) {
    var _props$hoverList = props.hoverList,
        hoverList = _props$hoverList === void 0 ? [] : _props$hoverList,
        _props$setHoverList = props.setHoverList,
        setHoverList = _props$setHoverList === void 0 ? function () {} : _props$setHoverList,
        name = props.name;

    if (hoverList.indexOf(name) === -1) {
      setHoverList([name].concat(_toConsumableArray(hoverList)).sort());
    }
  ...
  endDrag: function endDrag(props, monitor) {
    var _props$setHoverList2 = props.setHoverList,
        setHoverList = _props$setHoverList2 === void 0 ? function () {} : _props$setHoverList2,
        _props$endDrag = props.endDrag,
        endDrag = _props$endDrag === void 0 ? function () {} : _props$endDrag;
...
var daymilliseconds = 24 * 60 * 60 * 1000; // 计算每一行的 class

var getRowClassName = function getRowClassName(time, interval, data, index, days, isHovered) {
  var now = new Date().getTime();
  var className = cx({
    'ebiz-calendar__backrow__cell_before': time + interval * 60 * 1000 < now,
    'hovered': !!isHovered
  }, 'ebiz-calendar__backrow__cell'); // 日和周的当前时间基准线

  if (now > data[0] - daymilliseconds * index && now < data[data.length - 1] + interval * 60 * 1000 + daymilliseconds * (days - index - 1)) {
    time = add_days(time, difference_in_calendar_days(now, time)).getTime();
  }
...
var BackCell = function BackCell(_ref) {
  var time = _ref.time,
      data = _ref.data,
      _ref$days = _ref.days,
      days = _ref$days === void 0 ? 1 : _ref$days,
      ...
      interval = _ref.interval,
      renderBackRow = _ref.renderBackRow,
      rowHeight = _ref.rowHeight,
      connectDropTarget = _ref.connectDropTarget,
      isHovered = _ref.isHovered,
      hoverList = _ref.hoverList,
      setHoverList = _ref.setHoverList,
      endDrag = _ref.endDrag;
  return connectDropTarget(React__default.createElement("div", {
    key: time,
    className: getRowClassName(time, interval, data, index, days, isHovered),
    style: {
      height: "".concat(rowHeight, "px")
    }
  }, React__default.createElement(DragEvent, {
    endDrag: endDrag,
    hoverList: hoverList,
...
var BackCellWraper = reactDnd.DropTarget('box', {
  drop: function drop(props) {
    return {
      name: props.time
    };
  },
  hover: throttle_1(function (props, monitor) {
    var hoverList = props.hoverList,
        setHoverList = props.setHoverList;
    var currentDragTime = monitor.getItem();
    ...
    var sortableList = _toConsumableArray(hoverList.sort());

    if (props.time > currentDragTime.name) {
      setHoverList([currentDragTime.name].concat(_toConsumableArray(sortableList.filter(function (item) {
        return item < props.time && item > currentDragTime.name;
      })), [props.time]));
    } else if (props.time < currentDragTime.name) {
      setHoverList([props.time].concat(_toConsumableArray(sortableList.filter(function (item) {
        return item < currentDragTime.name && item > props.time;
...
var BackRow = function BackRow(props) {
  var _props$hoverList = props.hoverList,
      hoverList = _props$hoverList === void 0 ? [] : _props$hoverList,
      _props$setHoverList = props.setHoverList,
      setHoverList = _props$setHoverList === void 0 ? function () {} : _props$setHoverList;
  var sortableList = hoverList.sort();
  return React__default.createElement("div", {
    className: "ebiz-calendar__backrow"
  }, props.data.map(function (time, index) {
    var isHovered = !!hoverList.length && time >= sortableList[0] && time <= sortableList[sortableList.length - 1];
    return React__default.createElement(BackCellWraper, _extends({
      key: "backcell-wrapper-".concat(index),
      isHovered: isHovered,
      hoverList: hoverList,
      setHoverList: setHoverList,
      time: time
...
var BackViewRow = function BackViewRow(props) {
  var _props$data = props.data,
      data = _props$data === void 0 ? [] : _props$data,
      days = props.days,
      restprops = _objectWithoutProperties(props, ["data", "days"]);

  return React__default.createElement("div", {
    className: "ebiz-calendar__backviewrow"
  }, React__default.createElement(BackViewCell, _extends({
    columnType: "dimension",
    data: [],
    day: ''
  }, restprops)), days.map(function (day) {
    var currentDate = dateFns_50(day.date, 'YYYY-MM-DD');
    var filterData = data.filter(function (item) {
      return item.date === currentDate;
    });
    return React__default.createElement(BackViewCell, _extends({
      key: "ebiz-calendar__".concat(currentDate),
      columnType: "content",
      data: filterData,
      day: currentDate
    }, restprops));
...
var BackViewCell = function BackViewCell(props) {
  var columnType = props.columnType,
      ...
      day = props.day;
  return React__default.createElement("div", {
    className: "ebiz-calendar__backviewrow__cell_before ebiz-calendar__backviewrow__cell ebiz-calendar__backviewrow__column",
    style: {
    ...
    className: "ebiz-calendar__columnstart"
...
var sortData = function sortData(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    // }
    var _data$i = data[i],
        startTimeI = _data$i.startTime,
        endTimeI = _data$i.endTime; // data[i].overlap = false;

    for (var j = 0; j < data.length; j++) {
      if (i === j) continue;
      var _data$j = data[j],
          startTimeJ = _data$j.startTime,
          endTimeJ = _data$j.endTime;
    ...
    for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = rows[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (new Date(row[row.length - 1].endTime).getTime() <= new Date(v.startTime).getTime()) {
            row.push(v);
            tmp = true;
            break;
          }
 ...
 */
var validateTimeLine = function validateTimeLine(timeStr) {
...
var getTimelineMinutes = function getTimelineMinutes(timeStr) {
  var tmp = timeStr.split(':').map(function (v) {
...
var getTimeLineList = function getTimeLineList(timeLineStart, timelineEnd, interval) {
  // 校验 timelineStart
  if (!validateTimeLine(timeLineStart)) {
    timeLineStart = '00:00';
    console.error("error with timelineStart: ".concat(timeLineStart, "\uFF0Cdefault start with \"00:00\""));
  } // 校验 timeLineEnd


  if (!validateTimeLine(timelineEnd)) {
    timelineEnd = '24:00';
    console.error("error with timelineEnd: ".concat(timelineEnd, "\uFF0Cdefault start with \"24:00\""));
  }

  var startTime = getTimelineMinutes(timeLineStart);
  var endTime = getTimelineMinutes(timelineEnd); // 校验 interval

  if (interval > endTime - startTime || (startTime - endTime) % interval !== 0) {
    interval = 15;
    console.error('interval is too big，or can not diveded');
  }

  var total = endTime - startTime;
  return Array(total / interval).fill(0).map(function (_, i) {
    return interval * i + startTime;
  });
};

var paddingTime = function paddingTime(time) {
  return (time >= 10 ? '' : '0') + time;
};

var getTimeLineStart = function getTimeLineStart(timeLineStart, data, interval) {
  var hour = +timeLineStart.split(':')[0];
  var minute = +timeLineStart.split(':')[1];
  data = data.sort(function (a, b) {
    return a.startTime >= b.startTime ? 1 : -1;
  });
  data.map(function (_ref) {
    ...
    var start = new Date(startTime).setHours(hour, minute, 0, 0);
  ...
  return "".concat(paddingTime(hour), ":").concat(paddingTime(minute));
};
var getTimeLineEnd = function getTimeLineEnd(timeLineEnd, data, interval) {
  var hour = +timeLineEnd.split(':')[0];
  var minute = +timeLineEnd.split(':')[1];
  data = data.sort(function (a, b) {
  ...
  data.map(function (_ref2) {
    ...
    var end = new Date(endTime).setHours(hour, minute, 0, 0);
...
var calcDurationPercent = function calcDurationPercent(startTime, endTime) {
  var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 24 * 60 * 60 * 1000;

  if (!dateFns_80(startTime, endTime)) {
    console.error("calcDurationPercent: ".concat(startTime, " and ").concat(endTime, " is not one day."));
  }
...
var Column = function Column(_ref) {
  var data = _ref.data,
      ...
      timeLineStart = _ref.timeLineStart,
      timeLineEnd = _ref.timeLineEnd;
  var FieldList = [];
  var SingleFieldList = []; // 无重叠时间的课程占据100%宽度

  var _timeLineStart$split = timeLineStart.split(':'),
      _timeLineStart$split2 = _slicedToArray(_timeLineStart$split, 2),
      hour = _timeLineStart$split2[0],
      minute = _timeLineStart$split2[1];

  var _timeLineEnd$split = timeLineEnd.split(':'),
      _timeLineEnd$split2 = _slicedToArray(_timeLineEnd$split, 2),
      endhour = _timeLineEnd$split2[0],
      endminute = _timeLineEnd$split2[1];

  data.map(function (item) {
    var low = new Date(item.startTime).setHours(+hour, +minute, 0, 0); // 起始时间点

    var top = new Date(item.startTime).setHours(+endhour, +endminute);
    var duration = top - low;
    var style = {
      top: "".concat(calcDurationPercent(item.startTime, low, duration) * 100, "%"),
      height: "".concat(calcDurationPercent(item.startTime, item.endTime, duration) * 100, "%"),
      width: '100%'
    };

    if (item.startTime >= low) {
      (item.overlap ? FieldList : SingleFieldList).push(_objectSpread2({}, item, {
        style: style
      }));
    }
  });
  return React__default.createElement(React.Fragment, null, React__default.createElement("div", {
    className: "ebiz-schedule__column"
  ...
  })), SingleFieldList.map(function (item) {
    return React__default.createElement("div", {
      key: item.startTime,
      className: "ebiz-schedule__column__field",
      style: item.style
...
var Columns = function Columns(_ref2) {
  var _ref2$max = _ref2.max,
      ...
      timeLineStart = _ref2.timeLineStart,
      timeLineEnd = _ref2.timeLineEnd;
  ...
  return React__default.createElement("div", {
    className: "ebiz-schedule__columns"
...
(function (ViewWords) {
  ViewWords["timeline"] = "\u65F6\u95F4";
  ViewWords["teacher"] = "\u8001\u5E08";
  ViewWords["classroom"] = "\u6559\u5BA4";
  ViewWords["class"] = "\u73ED\u7EA7";
})(ViewWords || (ViewWords = {}));
...
function (_Component) {
  ...
  function WeekSchedule() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(WeekSchedule)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(WeekSchedule, [{
    key: "getTimeline",
    value: function getTimeline(day) {
      var interval = this.props.interval;
      return getTimeLineList(this.start, this.end, interval).map(function (t) {
        return day.setHours(0, 0, 0, 0) + t * 60 * 1000;
      });
    }
  }, {
    key: "getViewsBody",
    value: function getViewsBody() {
      var _this2 = this;

      var _this$props = this.props,
          interval = _this$props.interval,
          renderBackRow = _this$props.renderBackRow,
      ...
      return React__default.createElement("div", {
        className: "ebiz-schedule__week__content",
        style: {
        ...
        var _ref = _this2.data[item] || {},
            _ref$data = _ref.data,
            data = _ref$data === void 0 ? [] : _ref$data,
            rest = _objectWithoutProperties(_ref, ["data"]);

        return React__default.createElement("div", {
          key: "ebiz-schedule_".concat(item),
          className: "ebiz-schedule__week__content__viewday"
        }, React__default.createElement(BackViewRow, {
          data: data,
          resource: _objectSpread2({
            resourceId: item
          }, rest),
          days: _this2.weeks,
          interval: interval,
      ...
      }), (!this.data || !Object.keys(this.data).length) && React__default.createElement("div", {
        className: "schedule_empty_words"
      }, "\u6682\u65E0", ViewWords[view]));
    }
  }, {
    key: "getTimelineBody",
    value: function getTimelineBody() {
      var _this3 = this;
      ...
      var _this$props2 = this.props,
          ...
          renderBackRow = _this$props2.renderBackRow,
          onShowMoreClick = _this$props2.onShowMoreClick,
          rowHeight = _this$props2.rowHeight,
          endDrag = _this$props2.endDrag;
      return React__default.createElement(React__default.Fragment, null, React__default.createElement(TimeLine, {
        data: this.timeline,
        interval: interval,
        rowHeight: rowHeight,
        ...
        className: "ebiz-schedule__week__content"
      }, this.weeks.map(function (day, index) {
        return React__default.createElement("div", {
          className: "ebiz-schedule__week__content__day",
          key: day.date.toString()
        }, React__default.createElement(BackRow, {
          data: _this3.getTimeline(new Date(day.date)),
          index: index,
          days: _this3.weeks.length,
          interval: interval,
          rowHeight: rowHeight,
          renderBackRow: renderBackRow,
          hoverList: _this3.state.hoverList,
          endDrag: endDrag,
          setHoverList: function setHoverList(list) {
            _this3.setState({
              hoverList: list
            });
          }
        }), React__default.createElement(Columns, {
          data: _this3.data[dateFns_50(day.date, 'YYYY-MM-DD')] || [],
          date: day.date,
          max: max,
          timeLineStart: _this3.start,
          timeLineEnd: _this3.end,
          renderField: renderField,
    ...
    value: function render() {
      var _this$props3 = this.props,
          renderWeekDays = _this$props3.renderWeekDays,
          view = _this$props3.view;
      return React__default.createElement("div", {
        className: "ebiz-schedule__week"
      }, React__default.createElement("div", {
        className: "ebiz-schedule__week__header",
        style: {
          paddingLeft: view !== 'timeline' ? '0' : '50px'
        }
      }, view !== 'timeline' && React__default.createElement("div", {
        className: "ebiz-schedule__week__header__cellstart"
      }, React__default.createElement("div", {
        className: "ebiz-schedule__week__header__viewstart"
      }, ViewWords[view || 'teacher'] || '')), this.weeks.map(function (day) {
        return React__default.createElement("div", {
          key: day.date.toString(),
          className: "ebiz-schedule__week__header__cell"
        }, renderWeekDays ? renderWeekDays(day.date) : "\u5468".concat(day.week, "(").concat(dateFns_50(day.date, 'M-DD'), ")"));
      })), React__default.createElement("section", {
        className: "ebiz-schedule__week__panel__wrap"
      }, React__default.createElement("div", {
        className: "ebiz-schedule__week__panel"
      }, view === 'timeline' && this.getTimelineBody(), view !== 'timeline' && this.getViewsBody())));
    }
  }, {
    key: "timeline",
    get: function get() {
      var _this$props4 = this.props,
          ...
          interval = _this$props4.interval;
      var start = this.start,
          end = this.end;
      return getTimeLineList(start, end, interval).map(function (t) {
    ...
    get: function get() {
      var _this$props5 = this.props,
          timeLineStart = _this$props5.timeLineStart,
    ...
    get: function get() {
      var _this$props6 = this.props,
          timeLineEnd = _this$props6.timeLineEnd,
    ...
    get: function get() {
      var _this$props7 = this.props,
          ...
          weekStartsOn = _this$props7.weekStartsOn;
      return zanMediaSdk.calendar.getWeekDays(current, weekStartsOn);
    }
  }, {
    key: "data",
    get: function get() {
...
_defineProperty(WeekSchedule, "defaultProps", {
  rowHeight: 60,
  weekStartsOn: 1,
  timeLineStart: '00:00',
  timeLineEnd: '24:00',
...
/*#__PURE__*/
function (_Component) {
  _inherits(DaySchedule, _Component);
  ...
  _createClass(DaySchedule, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("section", {
        className: "ebiz-schedule__day"
      }, React__default.createElement("div", {
        className: "ebiz-schedule__day__content"
      }, React__default.createElement(TimeLine, {
        data: this.timeline,
        interval: interval,
        rowHeight: rowHeight
      }), React__default.createElement("div", {
        className: "ebiz-schedule__day__panel"
      }, React__default.createElement(BackRow, {
        data: this.timeline,
        interval: interval,
        rowHeight: rowHeight,
    ...
    get: function get() {
      var _this$props3 = this.props,
          timeLineStart = _this$props3.timeLineStart,
    ...
    get: function get() {
      var _this$props4 = this.props,
          timeLineEnd = _this$props4.timeLineEnd,
          interval = _this$props4.interval,
...
_defineProperty(DaySchedule, "defaultProps", {
  rowHeight: 60,
  timeLineStart: '00:00',
  timeLineEnd: '24:00',
  interval: 15
  ...
  _createClass(Schedule, [{
    ...
    value: function renderMonth() {
      var _this$props = this.props,
          ...
          dateFullCellRender = _this$props.dateFullCellRender,
          onSelect = _this$props.onSelect;
      return React__default.createElement(MonthSchedule, {
        type: "month",
        current: current,
        weekStartsOn: weekStartsOn,
        data: data,
    ...
    value: function renderWeek() {
      var _this$props2 = this.props,
          data = _this$props2.data,
          current = _this$props2.current,
          weekStartsOn = _this$props2.weekStartsOn,
          timeLineStart = _this$props2.timeLineStart,
          timelineEnd = _this$props2.timelineEnd,
          interval = _this$props2.interval,
          rowHeight = _this$props2.rowHeight,
          max = _this$props2.max,
          renderField = _this$props2.renderField,
          renderBackRow = _this$props2.renderBackRow,
          onShowMoreClick = _this$props2.onShowMoreClick,
          renderWeekDays = _this$props2.renderWeekDays,
          _this$props2$view = _this$props2.view,
          view = _this$props2$view === void 0 ? 'timeline' : _this$props2$view,
          endDrag = _this$props2.endDrag;
      return React__default.createElement(WeekSchedule, {
        type: "week",
        view: view,
        data: data,
        current: current,
    ...
    value: function renderDay() {
      var _this$props3 = this.props,
          ...
          current = _this$props3.current,
          timeLineStart = _this$props3.timeLineStart,
          timelineEnd = _this$props3.timelineEnd,
          interval = _this$props3.interval,
          rowHeight = _this$props3.rowHeight,
          renderField = _this$props3.renderField,
          renderBackRow = _this$props3.renderBackRow,
          endDrag = _this$props3.endDrag;
      var dayData = data[dateFns_50(current, 'YYYY-MM-DD')] || [];
      return React__default.createElement(DaySchedule, {
        type: "day",
        data: dayData,
        current: current,
        rowHeight: rowHeight,
    ...
    value: function render() {
      ...
      return React__default.createElement(reactDnd.DndProvider, {
        backend: HTML5Backend__default
      }, React__default.createElement("div", {
        className: "ebiz-schedule"
      }, type === 'day' && this.renderDay(), type === 'week' && this.renderWeek(), type === 'month' && this.renderMonth()));
    }
  }]);
