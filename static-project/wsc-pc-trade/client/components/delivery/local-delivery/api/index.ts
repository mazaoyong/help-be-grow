...
import {
  ...
  ITogglePartnersReq,
  IUpdateSettingReq,
  IQueryTakeoutChannelReq,
  ITakeoutChannelAuthorityRes,
  IQueryBindShopReq,
 ...
 * 获取自结算授权参数
 */
export const getAuthorizeParams = (data: IQueryTakeoutChannelReq) => {
  return ajax<ITakeoutChannelAuthorityRes>(`${V4_API}/getAuthorizeParams.json`, {
    method: 'GET',
    data: assignKdtId(data),
  });
};
 ...
 * 自结算解除授权
 */
export const deAuthorize = (data: IQueryTakeoutChannelReq) => {
  return ajax<boolean>(`${V4_API}/deAuthorize.json`, {
    method: 'POST',
    contentType: 'application/json',
    data: assignKdtId(data),
  });
 ...
 * 自结算刷新授权结果
 */
export const refreshAuthorizeResult = (data: IQueryTakeoutChannelReq) => {
  return ajax<string>(`${V4_API}/refreshAuthorizeResult.json`, {
    method: 'POST',
    contentType: 'application/json',
    data: assignKdtId(data),
  });
 ...
 * 自结算绑定或者换绑门店
 */
export const saveOrUpdateBandShop = (data: IQueryBindShopReq) => {
  return ajax<boolean>(`${V4_API}/saveOrUpdateBandShop.json`, {
    method: 'POST',
    contentType: 'application/json',
    data: assignKdtId(data),
  });
