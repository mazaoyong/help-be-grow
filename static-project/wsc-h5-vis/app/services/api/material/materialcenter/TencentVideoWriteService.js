...
/** com.youzan.material.materialcenter.api.service.general.video.TencentVideoWriteService -  */
class TencentVideoWriteService extends BaseService {
  get SERVICE_NAME() {
  ...
  *
  ...
  {@link OperatorTypeEnum}
             ...
             *  @return {Promise}
             */
  async getVideoUploadToken(request) {
  ...
  *
             ...
             *  @param {string} request.coverUrl - 封面url(可选,需是完整的有赞系图片url,eg:https://img01.yzcdn.cn/xxx.jpg)
...
module.exports = TencentVideoWriteService;
