...
const STATIC_ASSETS = {
  backgroundImage: 'https://b.yzcdn.cn/public_files/2019/09/23/7a2d939a2116fe24fd451e9910c906fa.png',
...
const shareTypeOptions = [
  {
    ...
    onClick: function() {
      this.$emit('logShare');
      this.showShare = !this.showShareAction;
  ...
  },
  {
    ...
    onClick: function() {
      this.$emit('logShare');
      this.showShareAction = !this.showShareAction;
      this.showSharePopup = true;
    },
  ...
  },
  {
    ...
    onClick: function() {
      ...
      SafeLink.redirect({
        url: `/wscvis/edu/moments/poster?postId=${feed.postId}&kdt_id=${feed.kdtId}`,
        kdtId: feed.kdtId,
      });
    },
  },
