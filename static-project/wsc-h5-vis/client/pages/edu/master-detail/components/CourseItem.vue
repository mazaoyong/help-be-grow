<template>
  <div class="course-item-container" @click="onPathToCourse">
    ...
    <div class="course-item-info">
      ...
      <div
        v-if="learntNum"
        class="course-item-text course-item-learnt"
      >
        {{ totalNum }}人学过
      </div>
    </div>
...
<script>
import { Icon } from 'vant/lib';
import { formatSalesNum } from '../utils';
import { fullfillImage } from '@/common/utils';
