...
export default {
  ...
  mounted() {
    ...
    WxAudio.addRecordMinuteListener(data => {
      console.info('[ChatControllAudio] addRecordMinuteListener', data);
      const handleMap = {
        end: () => {
        ...
        start: () => {
          console.info('[ChatControllAudio] 自动开始 一分钟结束 开始又一次录音');
