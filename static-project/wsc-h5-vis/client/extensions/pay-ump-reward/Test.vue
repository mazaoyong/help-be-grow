  ...
  <div>
    ...
    <div class="ump-reward">
      ...
      >
        <div class="ump-reward__content">
          <!-- 课程奖励 -->
          <list-item
            thumbnail-url="https://img01.yzcdn.cn/upload_files/2021/03/17/b256ee6edba747dc18e4a2a81e255b85.jpg!large.webp"
            title="lining-入学奖励-送赠品001"
            subtitle="0.02课时"
          >
    ...
    <div class="ump-reward">
      ...
      >
        <div class="ump-reward__content">
          <!-- 积分奖励 -->
          <div class="ump-reward__content--points">
            <p v-theme.main>
              恭喜获得 300 积分
            </p>
            <p v-theme.main>
